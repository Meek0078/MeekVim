    ...
    config = function()
        ...
        lspconfig.lemminx.setup({
            ...
            on_attach = function(client, bufnr)
                -- Set buffer-local formatting options
                ...
                -- Optional: manually override formatting options passed to LSP
                client.server_capabilities.documentFormattingProvider = true

                -- Force a format with specific options
                vim.lsp.buf.format({
                    bufnr = bufnr,
                    format_options = {
                        tabSize = 4,
